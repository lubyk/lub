--[[------------------------------------------------------
  ...
  available with lub.Doc. This first paragraph is output as "summary".
...
local lib = class 'lub.DocTest'


-- # Create

-- Creating an lub.DocTest is done by providing a table of parameters. 
--
-- Usage example:
--
--   require 'lubyk'
